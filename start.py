...
async def cmd_start(message: Message, state: FSMContext):
    ...
    if user and user["home_city"]:
        ...
        await message.answer(
            ...
            "хто цікавий. Тих, кого вже лайкнули чи скіпнули, бот більше не покаже\n"
        ...
        await message.answer(
            ...
            "Тих, кого вже лайкнули чи скіпнули, бот більше не покаже\n"
            "🏠 *Куди я хочу поїхати* — шукайте, хто живе саме там, куди ви хочете поїхати\n"
            "📥 *Хто їде до мене* — дивіться, хто хоче приїхати у ваше місто\n"
            ...
            "При додаванні поїздки ви можете обрати кілька варіантів того, кого "
            "готові прийняти у себе (сім'ю, пару, соло-мандрівника — будь-яку комбінацію)\n\n"
...
async def cmd_help(message: Message):
    await message.answer(
        ...
        "2️⃣ /trip — додати свою поїздку. Тут же оберіть, кого готові прийняти "
        "у себе — можна обрати декілька варіантів одразу (сім'я, пара, соло тощо)\n"
        "3️⃣ /browse — переглянути мандрівників і лайкати. Тих, кого вже "
        "лайкнули чи скіпнули, бот більше не покаже\n"
        "4️⃣ Взаємний лайк = матч 🎊 — можна написати напряму, залишити відгук "
        "або позначити «Не домовились», якщо обмін не відбувся\n"
